...
st.subheader("Current Gain / Loss in stocks")
...
while True:
    for symbol_option in df_current_gain_loss.index:
        if df_current_gain_loss.loc[symbol_option, 'volume'] != 0:
            ...
            df_current_gain_loss.loc[symbol_option, 'gain / loss ($)'] = df_current_gain_loss.loc[symbol_option,'c_price'] * df_current_gain_loss.loc[symbol_option,'volume'] - df_current_gain_loss.loc[symbol_option,'total']
